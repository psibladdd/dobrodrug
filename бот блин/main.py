...
async def handle_dice(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if update.message.message_thread_id == 4:
        ...
        if dice.emoji == '🎲':  # Кубик
            ...
            elif dice.value == 17 or dice.value == 13 or dice.value == 23 or dice.value == 3 or dice.value == 6 or dice.value == 4 or dice.value == 9 or dice.value == 5 or dice.value == 2 or dice.value == 49 or dice.value == 33 or dice.value == 18:
                new_balance = current_balance + 3
